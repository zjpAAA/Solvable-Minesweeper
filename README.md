...
黑猫扫雷v2.0，内部集成了三大判雷引擎，具有全部6种无猜扫雷模式+标准+win7。不同于Arbiter的专业、Minesweeper X的小巧，黑猫扫雷的开发人员希望制作出一款很“酷”的扫雷。外观上它只是一款普普通通的标准扫雷，但它能任意调大小，能调窗口的透明度。它甚至能当作浏览器，能一键打开扫雷网，或者用扫雷在某个能扫雷的网站上扫雷……在游戏性方面，弱可猜、强可猜的模式都是独一无二的，也是唯一自带新手教程的扫雷。对于高玩来说，它又是专业的，能够计算3BV/s、STNB、RQP指标并展示。此外，它功能强大但不会打扰玩家，当玩家不去主动打开时，就不会弹出任何窗口，且任何窗口都可以按下空格键快速关闭。
